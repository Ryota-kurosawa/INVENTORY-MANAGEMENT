...
public class HRDFabricInfoEntity {
	@PrimaryKey
	 ...
	 */
	public HRDFabricInfoEntity(Long id, int controlnumber, String material, String size, String storagelocation,
